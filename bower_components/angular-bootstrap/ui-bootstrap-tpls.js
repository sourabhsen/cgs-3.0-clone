  ...
  .directive('uibTypeahead', ['$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$uibPosition', 'uibTypeaheadParser',
    ...
    return {
      ...
      link: function(originalScope, element, attrs, ctrls) {
        ...
        //If input matches exactly (case-insensitive) with on of the item
        var foucsOnExact = attrs.typeaheadFoucsOnExact ? originalScope.$eval(attrs.typeaheadFoucsOnExact) : false;
